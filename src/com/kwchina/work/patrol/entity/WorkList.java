 ...
 */
@Entity
@Table(name = "x_patrol_workList")//, schema = "dbo"
@ObjectId(id="xId")
public class WorkList implements JSONNotAware{

	private Integer xId;
	private Integer listId;        //主键
    private String workTitle;      //标题
    private String bigItems;       //巡检大项  (id拼接，英文逗号隔开)
...
//	private String endTime;        //结束时间（小时：分钟）
	...
	public void setWorkTitle(String workTitle) {
 	...
 	@Column(columnDefinition = "nvarchar(500)",nullable = true)
	public String getBigItems() {
		return bigItems;
	}

	public void setBigItems(String bigItems) {
