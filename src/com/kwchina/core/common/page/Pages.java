...
import com.kwchina.work.sys.SystemConstant;
    ...
    private void getPageBreakStr() {
        ...
        if (this.style == 2) {
            ...
            /*sb.append(SystemConstant.MESSAGE.getMessage(this.request.getLocale(),
                    ...
                    String.valueOf(this.allpage)));*/
            //sb.append(SysGeneralMethod.getPagesign());
            sb.append("共" + this.totals + "条  第" + this.cpage + "/" + this.allpage + "页");
        ...
        if (this.style == 3) {
            ...
            if (this.filename != null && this.filename.length() > 0) {
                ...
                sb.append("&nbsp;&nbsp;第<font color=red>" + this.cpage + "</font>/" + this.allpage + "页");
                sb.append("</div></td></tr>\n");
                sb.append("</FORM>\n");
                sb.append("</table>\n");
        ...
        if (this.style == 4) {
			...
			if (this.filename != null && this.filename.length() > 0) {
				...
				// filename = filename.toLowerCase();
				int index = filename.indexOf("?");
				String path = filename + "t=" + this.totals;
				if (index != -1) {
					postto = filename.substring(0, index);
					filename = filename.substring(index + 1, filename.length());
				} else {
				...
				sb.append("<FORM METHOD=POST ACTION=\"" + path + "\">\n");
				sb.append("<tr><td><div align=\"right\">\n");
				// System.out.println(filename);
				...
				if (this.cpage > 1) {
					...
					sb.append("<img alt='");
					sb.append(pagesign[0]);
					sb.append("' src='../../images/firstpg.d.gif' border=0 >&nbsp;&nbsp");
					// sb.append("style='background-image:url('<c:url
					// value='/images'/>/firstpg.d.gif')'");
					// sb.append("'>");
					// sb.append(pagesign[0]);
					sb.append("</a> <a style='text-decoration: none;' href='");
					sb.append(this.filename);
					sb.append("inpages=");
					sb.append((cpage - 1));
					// new
					...
					sb.append("<img alt='");
					sb.append(pagesign[1]);
					sb.append("' src='../../images/prevpg.d.gif' border=0 >&nbsp;&nbsp");
					// sb.append("style='background-image:url('<c:url
					// value='/images'/>/prevpg.d.gif')'");
					// sb.append("'>");
					// sb.append(pagesign[1]);
					sb.append("</a>");
				...
				if (this.cpage < this.allpage) {
					...
					sb.append("<img alt='");
					sb.append(pagesign[2]);
					sb.append("' src='../../images/nextpg.d.gif' border=0 >&nbsp;&nbsp");
					// sb.append("&style='background-image:url('<c:url
					// value='/images'/>/nextpg.d.gif')'");
					// sb.append("'>");
					// sb.append(pagesign[2]);
					sb.append("</a><a style='text-decoration: none;' href='");
					sb.append(this.filename);
					...
					sb.append("<img alt='");
					sb.append(pagesign[3]);
					sb.append("' src='../../images/lastpg.d.gif' border=0 >");
					// sb.append("&style='background-image:url('<c:url
					// value='/images'/>/lastpg.d.gif')'");
					// sb.append("'>");
					// sb.append(pagesign[3]);
					sb.append("</a> ");
					/*
					 * this.listPageBreak += "[<a href='" + this.filename +
					 * "inpages=" + (cpage + 1) + "' >" + pagesign[2] + "</a>] [<a
					 * href='" + this.filename + "inpages=" + this.allpage + "'' >" +
					 * pagesign[3] + "</a>] ";
					 */
				}
				int _cpage = 0;
				...
				if (allpage > 0) {
					...
					sb.append("<select name='inpages' onchange=\"this.form.submit();\" >");
					for (int i = 1; i <= this.allpage; i++) {
						sb.append("<option value=");
						sb.append(i);
						if (i == cpage) {
							sb.append("&nbsp selected ");
						}
						sb.append(">");
						// sb.append("<option>");
						sb.append(i);
					...
					sb.append("</select>");
					sb.append("&nbsp;&nbsp;&nbsp;&nbsp;");
					sb.append("共&nbsp;&nbsp;"+String.valueOf(this.totals)+"&nbsp;&nbsp;条");
				}else{
					sb.append("共&nbsp;&nbsp;0&nbsp;&nbsp;条记录");
				}
