...
public class DateHelper {
	 ...
	 * @return
	 */
	public static String formatDurTime(int seconds){
//		String str = "221";
//		 int seconds = Integer.parseInt(str);
	 ...
	 * @return
	 */
	public static String formatNormalTime(int seconds){
//		String str = "221";
//		 int seconds = Integer.parseInt(str);
		 int temp=0;
		 StringBuffer sb=new StringBuffer();
	 ...
	 * @return
	 */
	public static int formatNowToMinutes(){
		Calendar now = Calendar.getInstance();
	...
	public static void main(String[] args)throws Exception {
		...
		System.out.println(getString(getFirstBeginDateOfMonth(DateHelper.getDate("2017-01-07"))));
		System.out.println(getString(getFirstEndDateOfMonth(DateHelper.getDate("2017-02-07"))));
	}
