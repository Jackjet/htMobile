 ...
 *
 */
public class CopyOfDateConverter implements Converter {
	/**
	 * ���ڸ�ʽ������.
	 */
	...
	// ע��һ�����ڵ�ת����ʽ
	static {
		CopyOfDateConverter.patterns.add("yyyy-MM-dd");
		CopyOfDateConverter.patterns.add("yyyy-MM-dd HH:mm");
		CopyOfDateConverter.patterns.add("yyyy-MM-dd HH:mm:ss");
		CopyOfDateConverter.patterns.add("yyyy/MM/dd HH:mm:ss");
	}
