    ...
    <script>
        function addLine() {
            var html = "<tr>\n" +
                ...
                "                                <td style=\"width:70%;vertical-align: center\"><textarea style=\"margin-left: 40px;margin-top: 10px\" rows=\"5\" class=\"form-control\" name=\"problem\"></textarea></td>\n" +
                "                            </tr>";
            $("#myTable").append(html);
        }
        ...
        function showDetail(month) {
            window.open("${pageContext.request.contextPath}/monthReport.htm?method=editFeedBack&month=" + month, "_self");
        }
...
<div class="container">
    <div class="row clearfix" style="margin-top: 80px">
        <div class="col-md-12 column">
            <form class="form-horizontal" role="form" action="/monthReport.htm?method=safeFeedBack" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" class="form-control" name="focusId" value="${feedback.focusId}"/>
                    </div>
                </div>
                <div class="form-group">
                    <table id="myTable" class="col-sm-offset-1">
                        <thead>
                        <tr>
                            <th style="width:30%;text-align:center;vertical-align: center">工作内容</th>
                            <th style="width:70%;text-align:center;vertical-align: center">发现问题</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${feedback.records}" var="record">
                            <tr>
                                ...
                                <td style="width:70%;vertical-align: center"><textarea
                                        ...
                                        name="problem">${record.value}</textarea></td>
                            </tr>
                        </c:forEach>
                    ...
                    <div class="form-group">
                        <c:if test="${feedback.attaches!=null}">
                            <div style="margin-top: 40px" class="col-sm-offset-1 col-sm-8">
                                <c:forEach items="${feedback.attaches}" var="attach" varStatus="a">
                                    <a href="${attach}" target="_blank"><img title="点击查看大图" width="180" height="150" src="${attach}"></a>
