...
function appendImgHtml(fileData,fileList,filesId) {
	...
	fileHtml += "<img src='"+folder+"/"+name+"' border=0 onload=\"setImgSize(this,32,32)\" onmouseover=\"showBigPic('big_"+uPath+"','"+realPath+"');\" onmouseout=\"hidBigPic('big_"+uPath+"');\">";
