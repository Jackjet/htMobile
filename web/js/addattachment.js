  ...
  var tempsum=1; 
	...
	function transinfor(){			 	
	 ...
	 function addtable(elId){
	    ...
	    htmlsrc=htmlsrc+'<input type="file" name="' + elId + tempsum +'" size="50" class="textfield">';	    
	    htmlsrc=htmlsrc+'</td></tr>';	   
	    htmlsrc=htmlsrc+'</table>';    
	    //alert(htmlsrc);
	    //alert(htmlEl);
	    
	    htmlsrc='<br><input type="file" name="' + elId + tempsum +'" size="50" class="textfield">';
     ...
     function addpic(elId,na,cl){
	    ...
	    htmlsrc='<br><input type="file" name="' + na  +'" class="'+ cl +' textfield" size="50">';
	    //newstyle.insertAdjacentHTML ("BeforeEnd",htmlsrc);
	    var htmlEl = document.getElementById(elId);
