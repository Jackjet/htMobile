		...
		<div id="right">
			...
			<div class="module">
				<div class="content">
					...
					<p>&nbsp;</p>
					<div class="news">
						<form:form commandName="smallCategoryVo" id="smallCategoryForm" name="smallCategoryForm" action="/patrol/smallCategory.htm?method=save" method="post">
							<form:hidden path="xId"/>  
							<form:hidden path="bigId"/> 
