...
<script type="text/javascript">
	$(document).ready(function(){
		//alert(50);
		$("#gbox_grid_35_structure").css("height",document.documentElement.clientHeight-50);
	});
	//新增
	function addStructure(){
		/*var returnStrTag = window.showModalDialog("/core/structureInfor.htm?method=edit",null,"dialogWidth:900px;dialogHeight:650px;center:Yes;dialogTop: 5px; dialogLeft: 300px;");
		if(returnStrTag == "Y") {
			//self.location.reload();
			loadTab("/core/structureInfor.htm?method=list", "5");
		}*/
		window.open("/core/structureInfor.htm?method=edit","_blank");
	}
	//修改
	function editStructure(structureId){
		/*var returnStrTag = window.showModalDialog("/core/structureInfor.htm?method=edit&structureId="+structureId,'',"dialogWidth:900px;dialogHeight:650px;center:Yes;dialogTop: 5px; dialogLeft: 300px;");
		if(returnStrTag == "Y") {
			//self.location.reload();
			loadTab("/core/structureInfor.htm?method=list", "5");
		}*/
		window.open("/core/structureInfor.htm?method=edit&structureId="+structureId,"_blank");
	}
	//删除
	function deleteStructure(structureId){
		...
		if (yes) {
			...
			form.action = "<c:url value='/core/structureInfor.htm'/>?method=delete&structureId="+structureId;
			form.submit();
		...
		if (yes) {
			$.ajax({
				url: "<c:url value='/core/structureInfor.htm'/>?method=delete&structureId="+structureId,	//删除数据的url
				cache: false,
				//data:{personId: rowId},
				type: "POST",
				dataType: "html",
...
<body>
<div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" id="gbox_grid_35_structure" dir="ltr" style="width: 100%;overflow-y:auto;">
<div class="ui-jqgrid-view" id="gview_grid_35" style="width: 100%">
  ...
  <div style="width: 100%" class="ui-state-default ui-jqgrid-hdiv">
    <div class="ui-jqgrid-hbox" style="width: 100%">
      <table cellspacing="0" cellpadding="0" border="0" aria-labelledby="gbox_grid_35_structure" role="grid" style="width: 100%" class="ui-jqgrid-htable">
          <thead>
	...
	<div class="ui-jqgrid-bdiv" style="height: auto; width: 100%">
		<div style="position: relative;">
			<div>
				<table cellspacing="0" cellpadding="0" border="0" id="grid_35" class="ui-jqgrid-btable" role="grid" aria-multiselectable="false" aria-labelledby="gbox_grid_35_structure" style="width: 100%">
					<tbody>
				...
				<tbody>
					<tr>
								...
								<tbody>
									<tr>
										<td class="ui-pg-button ui-corner-all" title="刷新表格" id="refresh_grid_35">
											<div class="ui-pg-div">
												<span class="ui-icon ui-icon-refresh" onclick="loadTab('/core/structureInfor.htm?method=list','5');"></span>
											</div>
										</td>
						...
						<td align="right" id="pager_35_right">
							<div class="ui-paging-info" style="text-align: right;" dir="ltr">共 ${fn:length(_StructureTree)-1} 条</div>
						</td>
					</tr>
				</tbody>
			</table>
