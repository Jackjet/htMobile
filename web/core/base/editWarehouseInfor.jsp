	...
	$(function(){
		$("#warehouseInforForm").Validform({
			...
			callback:function(data){
				...
				window.opener.loadTab('listWarehouse.jsp', '11');
			}
		});  
	...
	<div id="wrap">
		...
		<div id="right">
			...
			<div class="module">
				<div class="content">
					<div class="xinxi">
						<strong>编辑仓库信息</strong>
					</div>
					<p>&nbsp;</p>
					<div class="news">
						<form:form commandName="warehouseInforVo" id="warehouseInforForm" action="/stock/warehouse.htm?method=save" method="post">
							<form:hidden path="houseId"/>
							<table width="800" border="0" cellpadding="0" cellspacing="0"
								class="doc">
								<tr>
									<td width="15%" align="right" nowrap="nowrap"><span class="blues">仓库名称：</span>&nbsp;&nbsp;</td>
									<td width="85%">
										<form:input path="houseName" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入仓库名称！"/> 
										<font color="red">*</font>
									</td>
								</tr>
								<tr>
									<td nowrap="nowrap" align="right"><span class="blues">仓库编码：</span>&nbsp;&nbsp;</td>
									<td>
										<form:input path="houseCode" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入仓库编码！" />
										<font color="red">*</font> 
									</td>
								</tr>
								...
								<tr>
									<td nowrap="nowrap" align="right"><span class="blues">描述：</span>&nbsp;&nbsp;</td>
									<td>
										<form:textarea path="description" cols="50" rows="5" class="textarea"/>
									</td>
								</tr>
