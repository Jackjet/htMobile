	...
	$(function(){
		$("#outOrderDeviceForm").Validform({
			...
			callback:function(data){
				...
				window.opener.loadTab('listOutOrderDevice.jsp', '14');
			}
		});  
	...
	<div id="wrap">
		...
		<div id="right">
			...
			<div class="module">
				<div class="content">
					<div class="xinxi">
						<strong>编辑设备信息</strong>
					</div>
					<p>&nbsp;</p>
					<div class="news">
						<form:form commandName="outOrderDeviceVo" id="outOrderDeviceForm" action="/stock/outOrderDevice.htm?method=save" method="post">
							<form:hidden path="deviceId"/>
							<table width="800" border="0" cellpadding="0" cellspacing="0"
								class="doc">
								<tr>
									<td width="15%" align="right" nowrap="nowrap"><span class="blues">设备名称：</span>&nbsp;&nbsp;</td>
									<td width="85%">
										<form:input path="deviceName" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入设备名称！"/> 
										<font color="red">*</font>
									</td>
								</tr>
								<tr>
									<td nowrap="nowrap" align="right"><span class="blues">设备编码：</span>&nbsp;&nbsp;</td>
									<td>
										<form:input path="deviceCode" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入设备编码！" />
										<font color="red">*</font> 
									</td>
								</tr>
								<tr>
									<td nowrap="nowrap" align="right"><span class="blues">车辆统一编号：</span>&nbsp;&nbsp;</td>
									<td>
										<form:input path="unionCode" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入车辆统一编号！" />
										<font color="red">*</font> 
									</td>
								</tr>
								<tr>
