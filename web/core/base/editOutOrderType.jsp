	...
	$(function(){
		$("#outOrderTypeForm").Validform({
			...
			callback:function(data){
				...
				window.opener.loadTab('listOutOrderType.jsp', '12');
			}
		});  
	...
	<div id="wrap">
		...
		<div id="right">
			...
			<div class="module">
				<div class="content">
					<div class="xinxi">
						<strong>编辑出库分类信息</strong>
					</div>
					<p>&nbsp;</p>
					<div class="news">
						<form:form commandName="outOrderTypeVo" id="outOrderTypeForm" action="/stock/outOrderType.htm?method=save" method="post">
							<form:hidden path="typeId"/>
							<table width="800" border="0" cellpadding="0" cellspacing="0"
								class="doc">
								<tr>
									<td width="15%" align="right" nowrap="nowrap"><span class="blues">出库分类名称：</span>&nbsp;&nbsp;</td>
									<td width="85%">
										<form:input path="typeName" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入出库分类名称！"/> 
										<font color="red">*</font>
									</td>
								</tr>
								<tr>
									<td nowrap="nowrap" align="right"><span class="blues">出库分类编码：</span>&nbsp;&nbsp;</td>
									<td>
										<form:input path="typeCode" size="20" class="textfield" datatype="*" sucmsg="填写正确！" nullmsg="请输入出库分类编码！" />
										<font color="red">*</font> 
									</td>
								</tr>
								<tr>
